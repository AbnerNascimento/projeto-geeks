...
const Aula1 = () => {
  const { value, handleNext, handlePrev } = Carousel(32);
  const imgSrc = `/2021/aula 1/${value}.jpg`;
...
const Aula2 = () => {
  const { value, handleNext, handlePrev } = Carousel(28); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2021/aula 2/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula3 = () => {
  const { value, handleNext, handlePrev } = Carousel(38); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2021/aula 3/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula4 = () => {
  const { value, handleNext, handlePrev } = Carousel(29); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2021/aula 4/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula5 = () => {
  const { value, handleNext, handlePrev } = Carousel(40); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2021/aula 5/${value}.jpg`; // Substitua pelo caminho correto
