...
const Aula1 = () => {
  ...
  const imgSrc = `/2019/aula 1/${value}.jpg`;
...
const Aula2 = () => {
  const { value, handleNext, handlePrev } = Carousel(14); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2019/aula 2/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula3 = () => {
  ...
  const imgSrc = `/2019/aula 3/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula4 = () => {
  const { value, handleNext, handlePrev } = Carousel(11); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2019/aula 4/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula5 = () => {
  const { value, handleNext, handlePrev } = Carousel(8); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2019/aula 5/${value}.jpg`; // Substitua pelo caminho correto
