...
const Aula1 = () => {
  ...
  const imgSrc = `/2020/aula 1/${value}.jpg`;
...
const Aula2 = () => {
  ...
  const imgSrc = `/2020/aula 2/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula3 = () => {
  const { value, handleNext, handlePrev } = Carousel(10); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2020/aula 3/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula4 = () => {
  const { value, handleNext, handlePrev } = Carousel(2); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2020/aula 4/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula5 = () => {
  const { value, handleNext, handlePrev } = Carousel(4); // Define o número máximo de slides para a segunda div
  const imgSrc = `/2020/aula 5/${value}.jpg`; // Substitua pelo caminho correto
