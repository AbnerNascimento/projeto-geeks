...
const Aula1 = () => {
  const { value, handleNext, handlePrev } = Carousel(16);
  const imgSrc = `/2022/aula 1/${value}.jpg`;
...
const Aula2 = () => {
  ...
  const imgSrc = `/2022/aula 2/${value}.jpg`; // Substitua pelo caminho correto
...
const Aula3 = () => {
  ...
  const imgSrc = `/2022/aula 3/${value}.jpg`; // Substitua pelo caminho correto
