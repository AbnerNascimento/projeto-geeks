  ...
  return (
    <header className="w-full z-50 flex items-center justify-around px-4 md:px-16 py-6 shadow-md">
        ...
        <ul className="navbar flex gap-2 text-xl">
          <li>
            <Link href="/" className="text-var(--main-color) border-r border-gray-500 font-medium text-1.1rem px-4 py-2 hover:text-var(--text-color) transition duration-500">
                Home
            </Link>
          </li>
          <li>
            <Link href="#contato" className="text-var(--main-color) border-r border-gray-500 font-medium text-1.1rem px-4 py-2 hover:text-var(--text-color) transition duration-500">
                Contato
            </Link>
          </li>
        </ul>
